...
const ModalLogin = () => {
  ...
  return (
    <>
      <h2 className={style['title']}>소셜로그인</h2>
      <div className={style['login-wrap']}>
          <p className='flx jsc aic' onClick={()=>loginHandler('google')}>
          ...
          <p className='flx jsc aic' onClick={()=>loginHandler('kakao')}>
            <img src='../images/ic_kakao.svg' alt='카카오 로그인 아이콘'/>
          </p>
      </div>
    </>
  )
